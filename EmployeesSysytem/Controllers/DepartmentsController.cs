                ...
                try
                {
                    ...
                    if (existingDepartment != null) {
                     existingDepartment.Code = department.Code;
                        ...
                        existingDepartment.ModifiedById = userId;
                        _context.Entry(existingDepartment).Property(x => x.CreatedById).IsModified = false;
                        _context.Entry(existingDepartment).Property(x=>x.CreatedOn).IsModified = false;
